...
import student.example.applock.model.Password;
import student.example.applock.services.BackgroundManager;
...
public class PatternLockAct extends AppCompatActivity {
    ...
    private void initLayout() {
        ...
        if(utilsPassword.getPassword() == null){
            ...
            int backColor = ResourcesCompat.getColor(getResources(),R.color.white, null);
